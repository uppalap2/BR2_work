...
% vary the end force and get the shape which will be discrete input to
% getEndForces.m
% L          = 45e-2;
if option == 0
    gravity_on = 0;
...
% initial EC_F = zeros(3,1) ; Used for getting the final shape without end
% force

EC_F = [3e-3;4e-3;10e-3];
