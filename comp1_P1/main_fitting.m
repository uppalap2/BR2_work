...
[params_opti] = getParams_g('Control valves_2\P1_27_8.mat',37.5e-2,.1075,[0;0;2*1e-3]*10,15,7.3,3.9561,.0097,.0014); % weight in gms is multiplied by 10 for force (EE)
end
