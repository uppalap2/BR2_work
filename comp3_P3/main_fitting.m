...
[params_opti] = getParams_g('Control valves_2\P3_28_30.mat',37.5e-2,.0863,[0;0;1.5*1e-3]*10,15,15,3.7135,.0046,.0024); % weight in gms is multiplied by 10 for force (EE)
end
